...
class AttendanceHistory extends StatelessWidget {
  AttendanceHistory({super.key, required this.totalTimePerDay,});
        ...
        itemBuilder: (context, index) {
          ...
          return Card(
            ...
            child: ListTile(
              ...
              title: Text(convertDateFormat(date),
              style: const TextStyle(fontSize: 17, fontWeight: FontWeight.bold),
              ),
              subtitle: Text("${time.inHours} hours ${time.inMinutes.remainder(60)} minutes ${time.inSeconds.remainder(60)} seconds",
